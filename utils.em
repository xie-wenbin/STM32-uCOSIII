...
//user added macro func
macro InsertUserFileHeader()
{
	//get crrunt time
	szTime = GetSysTime(1)
	Day = szTime.Day
	...
	InsBufLine(hbuf, 1, "*****************************************************************")
	InsBufLine(hbuf, 2, "* \@file: xx.h")
	InsBufLine(hbuf, 3, "* \@author: shzn  ")
...
macro Flinger_ExegesisCode()
{
    ...
    InsBufLine(hbuf, lnFirst + 1, "#ifdef FLINGER_CODE /* @Month@/@Day@/@Year@ */")
